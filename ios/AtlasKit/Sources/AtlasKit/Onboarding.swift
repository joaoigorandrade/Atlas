...
public final class Onboarding {
    ...
    public func buildMap() {
        ...
        build = Task { [form] in
            ...
            do {
                ...
                stage = .welcome
                message = Self.copy(for: error, doing: "montar seu mapa")
                return
            }
            ...
            do {
                ...
                message = Self.copy(for: error, doing: "preparar o nivelamento")
                finish()
            }
        }
    }
    ...
    public func answer(_ index: Int) {
        ...
        Task {
            do {
                ...
                answered = diagnosticCount
                message = Self.copy(for: error, doing: "escrever a próxima pergunta")
            }
        }
    }
    ...
    /// Something true about the code, in the learner's language. The upstream
    /// `message` is for logs and never reaches the screen.
    static func copy(for error: Error, doing what: String) -> String {
...
extension Array {
    /// The question after the last one that has arrived is a real question on
    /// its way, not a crash.
